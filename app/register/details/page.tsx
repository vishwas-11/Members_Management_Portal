...
import { z } from 'zod'
import { PlusCircle, Trash2, ChevronRight, ChevronLeft, Loader2, CheckCircle2, ChurchIcon } from 'lucide-react'
    ...
    <div className="min-h-screen bg-cream-50 py-12 px-4 relative">
      ...
      <div className="max-w-xl mx-auto relative z-10">
        <div className="flex items-center gap-2.5 mb-8">
          <div className="w-8 h-8 border border-forest-600 rounded-md flex items-center justify-center bg-white shadow-sm">
